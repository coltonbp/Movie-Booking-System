...
class PurchaseWindow:
    def __init__(self, parent):
        ...
        self.paypal_button = tk.Button(self.parent, text="Pay with PayPal", command=self.pay_with_paypal)
        self.paypal_button.grid(row=3, column=0, columnspan=2, padx=5, pady=5)
    ...
    def pay_with_paypal(self):
        # Open PayPal payment page in web browser
